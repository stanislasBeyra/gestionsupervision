...
@section('title', 'Éléments d\'Environnement')
    ...
    <div class="page-header">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start">
            <div class="mb-3 mb-md-0" style="width: 100%;">
                <h1 class="page-title">Liste des Éléments d'environnement</h1>
                <p class="page-subtitle">Aperçu de la vue des Éléments d'environnement</p>
            </div>
...
<script>
    ...
    function exportToExcel() {
        try {
            ...
            XLSX.utils.book_append_sheet(wb, ws, "Éléments d'environnement");
            XLSX.writeFile(wb, `elements_environnement_${new Date().toISOString().split('T')[0]}.xlsx`);
