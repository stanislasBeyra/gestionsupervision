...
<div class="page-container">
        ...
        <div class="page-header">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start">
                <div class="mb-3 mb-md-0" style="width: 100%;">
                    <h1 class="page-title">Liste des supervisés</h1>
                    <p class="page-subtitle">Aperçu de la vue des supervisés</p>
                </div>
        ...
        <div class="page-header">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start">
                <div class="mb-3 mb-md-0">
                    <h1 class="page-title" id="formTitle">Nouveau supervisé</h1>
                    <p class="page-subtitle" id="formSubtitle">Ajouter un nouveau supervisé</p>
                </div>
    ...
    <div class="drawer" id="detailDrawer">
        <div class="drawer-header">
            <h2 class="drawer-title">Détails du supervisé</h2>
...
<script>
    ...
    const SuperviseManager = {
        ...
        showForm() {
            ...
            document.getElementById('formSubtitle').textContent = this.editingRow ? 'Modifier les informations du supervisé' : 'Ajouter un nouveau supervisé';
        },
        ...
        checkEmptyTable() {
            ...
            if (tableBody && emptyMessage) {
                const hasRows = tableBody.querySelectorAll('tr').length > 0 || document.getElementById('mobile-cards').children.length > 0;
...
`;
        ...
        renderPagination(paginationData) {
            ...
            let paginationHTML = `
            <nav aria-label="Pagination des supervisés">
                <ul class="pagination">
        `;
        ...
        async exportToExcel() {
            try {
                ...
                const url = `/api/supervisers/export${search ? '?search=' + encodeURIComponent(search) : ''}`;
