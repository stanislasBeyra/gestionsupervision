    ...
    <div id="table-section" class="fade-in">
        <div class="row mb-4">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1">Liste des supervisés</h2>
                    <p class="text-muted mb-0">Aperçu de la vue des supervisés</p>
                </div>
                <div class="d-flex gap-2">
                    ...
                    <button type="button" class="btn btn-primary" onclick="showForm()">
                        <i class="fas fa-plus-circle me-2"></i> Ajouter un supervisé
                    </button>
                </div>
            </div>
        </div>
